...
// BuildContext updates the RedisConnection object with information from the check context.
...
// Validate checks the RedisConnection object for any configuration errors.
...
// Check performs the actual connection attempt to the Redis server or cluster.
...
// checkStandAlone handles the connection check for a standalone Redis server.
...
// checkCluster handles the connection check for a Redis cluster.
